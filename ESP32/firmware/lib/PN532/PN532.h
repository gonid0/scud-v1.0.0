...
public:
    ...
    // RFConfiguration CfgItem 0x02: fATR_RES_Timeout, fRetryTimeout.
    // Значения: 0x00=100µs, +1 удваивает, 0x0F=3.28s. Для HCE ставь ≥0x0E.
    bool setRfTimings(uint8_t fATR_RES, uint8_t fRetry);
...
private:
    ...
    uint8_t pn532_packetbuffer[300];
